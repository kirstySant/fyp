...
void Filtering()
{
    ...
    String folder = "/home/kirsty/Desktop/JOHN NAPIER FYP/Testing/new_bleed4Contrast"; // again we are using the Opencv's embedded "String" class
    
    glob(folder, filenames);
    stringstream ss; //to hold image name;
    //cout << "filtering-glob-done" << endl;
    string name = "/home/kirsty/Desktop/JOHN NAPIER FYP/Testing/testBilateral/bilateral_";
    string type = ".png";
    int ct = 0;
...
void Skull_Stripping()
{
    ...
    vector<String> filenames; // notice here that we are using the Opencv's embedded "String" class
    String folder = "/home/kirsty/Desktop/JOHN NAPIER FYP/Testing/testBilateral"; // again we are using the Opencv's embedded "String" class
    
    vector<String> filenames2; // notice here that we are using the Opencv's embedded "String" class
    String folder2 = "/home/kirsty/Desktop/JOHN NAPIER FYP/SegmentedTissue"; // again we are using the Opencv's embedded "String" class
    
    glob(folder, filenames);
    //cout << "skull stripping glob 1" << endl;
    glob(folder2, filenames2);
    //cout << "skull stripping glob 2" << endl;
    cout << filenames2.size() << endl;    
    stringstream ss; //to hold image name;
    stringstream ss2; //to hold image name;
    stringstream ss3; //to hold image name;
    stringstream ss4; //to hold image name;
    
    string name = "/home/kirsty/Desktop/JOHN NAPIER FYP/InitialThreshold/threshold_";//location to store the removed skull
    string name2 = "/home/kirsty/Desktop/JOHN NAPIER FYP/SegmentedSkull/SegmentedSkull_";//loacation to store the final image
    string name3 = "/home/kirsty/Desktop/JOHN NAPIER FYP/RemovedTissue/RemovedTissue_";//location to store the removed tissue
    string name4 = "/home/kirsty/Desktop/JOHN NAPIER FYP/SegmentedTissue/SegmentedTissue_"; //location to store the segmented head
    string type = ".jpg";
    ...
    for(size_t j = 0; j < filenames.size(); ++j)
    {
        ...
        {
        	//cout << "skull stripping image found" << endl;
            ...
            if(! src2.data )                              // Check for invalid input
        {
            ...
            //cout << "segmented skull iamge read" << endl;
...
{
    vector<String> filenames; // notice here that we are using the Opencv's embedded "String" class
    String folder = "/home/kirsty/Desktop/JOHN NAPIER FYP/SegmentedSkull"; // again we are using the Opencv's embedded "String" class
    glob(folder, filenames);
    stringstream ss; //to hold image name;
	string name = "/home/kirsty/Desktop/JOHN NAPIER FYP/Haemorrhage/haemorrhage_";//location to store the removed skull
    string type = ".png";
    ...
    string name2 = "/home/kirsty/Desktop/JOHN NAPIER FYP/GrayThreshold/thresh_";
    string type2 = ".png";
    ...
    for(size_t j = 0; j < filenames.size(); ++j)//looping thriugh all the files
    {
        ...
        else // if the input is valid
        {
            ...
            double aim2 = aim + 52;//56;//57;//52; //upper threshold
            //
            ...
            waitKey();
            if (ct < 9)
                ss2<<name2<<"0"<<(ct += 1)<<type2; //joining name and number.
            else
                ss2<<name2<<(ct += 1)<<type2; //joining name and number.
            //ss<<name<<(ct += 1)<<type; //joining name and number.
            
            string filename2 = ss2.str();
            ss2.str("");
            imwrite(filename2, showThresh); // saving image (GRAY THRESHOLD)
            /*if (j == 23)
