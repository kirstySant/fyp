...
void Haemorrhage_Detection()
{
    ...
    stringstream ss2; //to hold image name;
    string name2 = "/home/kirsty/Desktop/fyp/fyp/classification/Training/grayscale/gs_";//location to store the removed skull
    string type2 = ".png";

    stringstream ss3; //to hold image name;
    string name3 = "/home/kirsty/Desktop/fyp/fyp/classification/Training/contour/c_";//location to store the removed skull
    string type3 = ".png";
